...
class LivingStyleSelectionAdapter(private val interaction: Interaction? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return LivingStyleSelectionViewHolder(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is LivingStyleSelectionViewHolder -> {
    ...
    class LivingStyleSelectionViewHolder
    constructor(
        itemView: View,
