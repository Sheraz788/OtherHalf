...
class OccupationSelectionAdapter(private val interaction: Interaction? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return OccupationSelectionViewHolder(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is OccupationSelectionViewHolder -> {
    ...
    class OccupationSelectionViewHolder
    constructor(
        itemView: View,
        ...
        fun bind(item: String) = with(itemView) {
            itemView.option_btn.setOnClickListener {
                interaction?.onItemSelected(adapterPosition, item, true, false, false, false)
            }
